...
| | |
| --- | --- |
| **Claim** | Under same-model co-location the measurement-driven probe reduces urgent SLO miss rate by about 10% relative, in **both** co-run states, at no cost to video goodput. |
