...
| **Scope** | N slices of one model with no other tenant. The mismatched arrangement is a different and much larger number -- see 1.12. gfx90a has only 1 and 2 ways re-measured since the timing fix. |
